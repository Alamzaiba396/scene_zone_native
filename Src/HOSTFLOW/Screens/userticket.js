  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.ticketTypeButtonsContainer}>
        ...
        <TouchableOpacity
          style={styles.ticketTypeButton} // Base style
        ...
        >
          {activeTab === 'active' ? (
            ...
            >
              <Text style={styles.ticketTypeButtonText}>Active Ticket</Text>
            </LinearGradient>
          ) : (
            <View style={styles.buttonBackgroundInactive}>
                <Text style={styles.ticketTypeButtonText}>Active Ticket</Text>
            </View>
          )}
        </TouchableOpacity>
        ...
        >
           {activeTab === 'past' ? (
            <LinearGradient
              ...
              style={styles.buttonBackground}
            >
              <Text style={styles.ticketTypeButtonText}>Past Ticket</Text>
            </LinearGradient>
          ) : (
             <View style={styles.buttonBackgroundInactive}>
                <Text style={styles.ticketTypeButtonText}>Past Ticket</Text>
...
const styles = StyleSheet.create({
  ...
  ticketTypeButtonsContainer: {
    ...
    borderRadius: 10,
    overflow: 'hidden', // Clip the gradient and buttons to the container's corners
  },
  buttonBackground: {
    flex: 1,
    alignItems: 'center',
  ...
  ticketTypeButton: {
    ...
    alignItems: 'center',
    paddingVertical:0 , // Remove padding from button, handled by inner view/gradient
  },
